#!/bin/bash
#SBATCH --time=0:30:0
#SBATCH --job-name=fusionet_c10_pruning
#SBATCH -c 8
#SBATCH --gres=gpu:2
#SBATCH --mem=32G
...
singularity exec --nv $TF_CONTAINER python3 $EXP_PATH/cifar10/fusionet/pruned/fusionet.py $DATASET $TRAINING $PRE_TRAINED $GPUS $P1 $P2 $P3 $P4 $P5
